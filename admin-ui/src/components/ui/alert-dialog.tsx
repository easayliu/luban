...
export function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={cn(
        "font-heading font-semibold text-lg leading-none sm:text-xl",
        className,
      )}
